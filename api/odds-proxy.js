// api/odds-proxy.js
// Simple proxy for TheOddsAPI. Deploy to Vercel (Hobby/free).
// Expects THE_ODDS_API_KEY set in environment variables.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Minimal transform: keep only fields we need (client will map to CSV)
